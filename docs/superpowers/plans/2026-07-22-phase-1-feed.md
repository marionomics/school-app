...
- [x] **Step 4: Run tests, generate migration**
...
- [x] **Step 1: Add dependencies and settings**
...
- [x] **Step 4: Implement storage module and config endpoint**
...
- [x] **Step 3: Implement attribution service, schemas, router**
...
- [x] **Step 3: Implement cursor service and endpoints**
...
- [x] **Step 3: Wire Home to the live feed**
...
- [x] **Step 3: Real like mutation with optimistic updates**
...
- [x] **Step 4: PostCard delete affordance + attachment open**
...
- [x] **Step 2: Implement reducer and hook**
...
- [x] **Step 3: Mount in Shell (students only)**
